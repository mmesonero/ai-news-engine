...
class Settings(BaseSettings):
    ...
    # Transcript fallback config — set to false in cloud envs without spare CPU.
    ...
    whisper_max_per_run: int = Field(default=15, description="Cap Whisper invocations per pipeline run.")
